...
<div class="flex-grow">
    ...
    <form id="data" action="{{ route('blog.control-panel.articles.update', $article->id) }}" method="POST">
        @method('PATCH')
        @csrf
    ...
    <form id="delete" action="{{ route('blog.control-panel.articles.destroy', $article->id) }}" method="POST">
        @method('DELETE')
        @csrf
    </form>
