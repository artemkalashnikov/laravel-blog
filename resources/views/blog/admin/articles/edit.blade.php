...
<div class="flex-grow">
    ...
    <form id="data" action="{{ route('blog.admin.articles.update', $article->id) }}" method="POST">
        @method('PATCH')
        @csrf
    ...
    <form id="delete" action="{{ route('blog.admin.articles.destroy', $article->id) }}" method="POST">
        @method('DELETE')
        @csrf
    </form>
