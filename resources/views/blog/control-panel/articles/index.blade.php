        ...
        <table class="table-fixed w-full">
            ...
            @foreach($articlesPaginator as $article)
                <tr @if(!$article->is_published) class="bg-red-50" @endif>
                    <td class="px-1 py-2"><a class="text-red-700 underline hover:no-underline hover:text-red-700" href="{{ route('blog.control-panel.articles.edit', $article->id) }}">{{ $article->title }}</a></td>
